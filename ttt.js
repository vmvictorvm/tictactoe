...
$(function () {
  ...
  function checkResult() {
    if ($('#1').text() !== '' && $('#1').text() === $('#2').text() && $('#1').text() === $('#3').text()) {
      $('#result').html('The winner is: ' + $('#1').text());
      win = true;
      $('button').css('display', 'block');  //Show refresh button once the match ended
      ...
      $('#result').html('The winner is: ' + $('#4').text());
      win = true;
      ...
      $('#result').html('The winner is: ' + $('#7').text());
      win = true;
      $('button').css('display', 'block');
      $('.square').css({'pointer-events':'none',
                    'background-color':'grey'});
      ...
      $('#result').html('The winner is: ' + $('#2').text());
      win = true;
      $('button').css('display', 'block');
      $('.square').css({'pointer-events':'none',
                    'background-color':'grey'});
      ...
      $('#result').html('The winner is: ' + $('#3').text());
      win = true;
      $('button').css('display', 'block');
      $('.square').css({'pointer-events':'none',
                    'background-color':'grey'});
